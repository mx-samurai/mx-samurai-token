...
//   console.log("Token configured: Start time set.");
  ...
  await mxsToken.setMaxTxAmount("100000000000000000000000000000");
  console.log("Token configured: Max transaction amount set.");

  const tokenTransfer = await mxsToken.transfer(vestingRouter.address, 12500000009);
...
//   await vestingRouter.createVesting("0x16E7451D072eA28f2952eefCd7cC4A30B1F6A557", "1000000000000000000000000000", "7776000", "0", "false");
  for (var i = 0; i < arr1.length; i++) {
    await vestingRouter.createVesting(arr1[i], "1000000000000000000000000000", "7776000", "0", "false");
